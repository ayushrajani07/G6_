...
from typing import Any, Callable, Dict, Iterable, Optional, Protocol, runtime_checkable, List

from src.metrics import generated as m  # type: ignore
from src.metrics.safe_emit import safe_emit  # type: ignore
...
class AbstractStreamBus(Protocol):
    name: str
    def publish(self, event_type: str, payload: Dict[str, Any], *, key: Optional[str] = None, meta: Optional[Dict[str, Any]] = None) -> StreamPublishResult: ...  # pragma: no cover
    def subscribe(self, *, filter_fn: Optional[Callable[[str], bool]] = None, from_id: Optional[int] = None) -> StreamSubscription: ...  # pragma: no cover
...
class _InMemoryStreamBus(AbstractStreamBus):
    ...
    def publish(self, event_type: str, payload: Dict[str, Any], *, key: Optional[str] = None, meta: Optional[Dict[str, Any]] = None) -> StreamPublishResult:
    ...
    def subscribe(self, *, filter_fn: Optional[Callable[[str], bool]] = None, from_id: Optional[int] = None) -> StreamSubscription:
...
class _StubExternalStreamBus(AbstractStreamBus):
    def __init__(self, name: str):
        self.name = name
    def publish(self, event_type: str, payload: Dict[str, Any], *, key: Optional[str] = None, meta: Optional[Dict[str, Any]] = None) -> StreamPublishResult:  # pragma: no cover - simple stub
    ...
    def subscribe(self, *, filter_fn: Optional[Callable[[str], bool]] = None, from_id: Optional[int] = None) -> StreamSubscription:  # pragma: no cover - stub
