...
Moved from legacy flat module `src.collectors.pipeline` into package
module `src.collectors.pipeline.core` to eliminate name collision with
the package directory required for exporting additional state objects.
