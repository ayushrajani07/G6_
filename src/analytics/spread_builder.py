...
class Spread:
    ...
    def buy(self, instrument_key: str, quantity: int = 1, data: Optional[Dict[str, Any]] = None) -> Spread:
        """Add a buy leg to the spread."""
        self.legs.append(Leg(instrument_key, quantity, True, data))
        return self
        
    def sell(self, instrument_key: str, quantity: int = 1, data: Optional[Dict[str, Any]] = None) -> Spread:
