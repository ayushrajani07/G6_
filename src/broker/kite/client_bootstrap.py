...
def build_client_if_possible(provider) -> None:
...
def ensure_client(provider) -> None:
...
def update_credentials(provider, api_key: Optional[str] = None, access_token: Optional[str] = None, rebuild: bool = True) -> None:
    if api_key:
